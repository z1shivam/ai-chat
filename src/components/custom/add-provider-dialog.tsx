...
export function AddProviderDialog({
  ...
  const handleOpenRouterSubmit = async () => {
    if (
      !openRouterForm.name ||
      !openRouterForm.apiKey ||
      openRouterForm.selectedModels.length === 0
    ) {
      return;
    }
    ...
    const provider: OpenRouterProviderConfig = {
      ...
      defaultHeaders: {
        ...(openRouterForm.httpReferer && {
          "HTTP-Referer": openRouterForm.httpReferer,
        }),
  ...
  const handleOpenAISubmit = async () => {
    ...
    const provider: OpenAIProviderConfig = {
      ...
      defaultHeaders: {
        ...(openAIForm.httpReferer && {
          "HTTP-Referer": openAIForm.httpReferer,
        }),
  ...
  const handleCustomSubmit = async () => {
    ...
    const provider: CustomProviderConfig = {
      ...
      defaultHeaders: {
        ...(customForm.httpReferer && {
          "HTTP-Referer": customForm.httpReferer,
        }),
  ...
  const filteredModels = OPENROUTER_FREE_MODELS.filter(
    (model) =>
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] max-w-4xl overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Configure a new AI provider. Currently, OpenAI SDK based providers
            are supported.
          </DialogDescription>
        </DialogHeader>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="openrouter" className="space-y-4">
            <div className="space-y-4">
              <div>
                <label htmlFor="or-name" className="text-sm font-medium">
                  Provider Name
                </label>
                <Input
                  id="or-name"
              ...
              <div>
                <label htmlFor="or-apikey" className="text-sm font-medium">
                  API Key
                </label>
                <Input
                  id="or-apikey"
                    ...
                    {filteredModels.map((model) => (
                      ...
                      >
                        <input
                          type="checkbox"
                          id={model.id}
                          checked={openRouterForm.selectedModels.includes(
                            model.id,
                          )}
                          onChange={(e) =>
              ...
              <Collapsible
                open={showAdvancedOR}
                onOpenChange={setShowAdvancedOR}
              >
                ...
                <CollapsibleContent className="mt-4 space-y-4">
                  <div>
                    <label htmlFor="or-referer" className="text-sm font-medium">
                  ...
                  <div>
                    <label htmlFor="or-title" className="text-sm font-medium">
                      Site Title (Optional)
                    </label>
                    <Input
                      id="or-title"
          ...
          <TabsContent value="openai" className="space-y-4">
            <div className="space-y-4">
              <div>
                <label htmlFor="oa-name" className="text-sm font-medium">
                  Provider Name
                </label>
                <Input
                  id="oa-name"
                  ...
                  onChange={(e) =>
                    setOpenAIForm((prev) => ({ ...prev, name: e.target.value }))
                  }
              ...
              <div>
                <label htmlFor="oa-apikey" className="text-sm font-medium">
                  API Key
                </label>
                <Input
                  id="oa-apikey"
              ...
              <Collapsible
                open={showAdvancedOA}
                onOpenChange={setShowAdvancedOA}
              >
                <CollapsibleTrigger asChild>
                  <Button
                    variant="ghost"
                ...
                <CollapsibleContent className="mt-4 space-y-4">
                  <div>
                    <label htmlFor="oa-baseurl" className="text-sm font-medium">
                      Base URL (Optional)
                    </label>
                    <Input
                      id="oa-baseurl"
                  ...
                  <div>
                    <label htmlFor="oa-referer" className="text-sm font-medium">
                      HTTP Referer (Optional)
                    </label>
                    <Input
                      id="oa-referer"
                  ...
                  <div>
                    <label htmlFor="oa-title" className="text-sm font-medium">
                      Site Title (Optional)
                    </label>
                    <Input
                      id="oa-title"
              ...
              <Button
                ...
                disabled={
                  !openAIForm.name || !openAIForm.apiKey || isSubmitting
                }
                className="w-full"
              >
          ...
          <TabsContent value="custom" className="space-y-4">
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="cu-apikey" className="text-sm font-medium">
                  API Key
                </label>
                <Input
                  id="cu-apikey"
              ...
              <div>
                <label htmlFor="cu-baseurl" className="text-sm font-medium">
                  Base URL
                </label>
                <Input
                  id="cu-baseurl"
              ...
              <Collapsible
                open={showAdvancedCustom}
                onOpenChange={setShowAdvancedCustom}
              >
                <CollapsibleTrigger asChild>
                  <Button
                    variant="ghost"
                ...
                <CollapsibleContent className="mt-4 space-y-4">
                  <div>
                    <label htmlFor="cu-referer" className="text-sm font-medium">
                      HTTP Referer (Optional)
                    </label>
                    <Input
                      id="cu-referer"
                  ...
                  <div>
                    <label htmlFor="cu-title" className="text-sm font-medium">
                      Site Title (Optional)
                    </label>
                    <Input
                      id="cu-title"
                ...
                <div className="mt-1 space-y-2">
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      disabled={
                        !customForm.newModelName || !customForm.newModelId
                      }
                      variant="outline"
                    >
                      Add
